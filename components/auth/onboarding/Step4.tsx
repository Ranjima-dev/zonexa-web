    ...
    return (
        <div className="min-h-screen flex items-center justify-center">
            ...
            <div className="w-full max-w-lg">
                ...
                {/* Card Container */}
                <div className="bg-white flex flex-col max-h-[85vh] p-8 relative z-10">
                    ...
                    <div className="space-y-2 mb-6">
                        ...
                        <p className="text-gray-500 text-sm">
                            Log in to your Paco account to explore your dream place to live across the world.
                        </p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pb-4">
                            ...
                            <div className="flex items-center gap-3 text-sm">
                                <button
                                    ...
                                    className={`h-5 w-5 rounded-md flex items-center justify-center border ${acceptTerms
                                        ? "bg-[#2673BE] border-[#2673BE]"
                                        : "border-gray-300"
                                        }`}
                                >
